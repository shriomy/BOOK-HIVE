    ...
    <div className="mt-10">
      ...
      {isQAVisible && (
        <>
          ...
          <div className="bg-[#2c1f19] rounded-lg p-6 mb-6">
          ...
          {loading ? (
            ...
            questions.map((question) => (
              <div
                key={question._id}
                className="bg-[#2c1f19] rounded-lg p-6 mb-6"
              >
                <h2
                  className="text-xl font-semibold text-[#edbf6d] cursor-pointer"
                  onClick={() =>
                      ...
                      {question.answers && question.answers.length > 0 ? (
                        ...
                        question.answers
                          ...
                          .map((answer) => (
                            <div
                              key={answer._id}
                              className="bg-[#1e1b18] border border-[#3e2723] p-4 rounded-md mt-4"
                            >
